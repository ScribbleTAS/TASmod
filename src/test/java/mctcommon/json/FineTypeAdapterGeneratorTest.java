...
class FineTypeAdapterGeneratorTest {
	...
	void testGenerateMulti() {
		...
		List<String> expected = Arrays.asList(String.format("package typeadapter;\n"
				...
				+ "\n"
				+ "import mctcommon.json.FineTypeAdapterGeneratorTest$TestSuperClass;\n"
				+ "import mctcommon.json.FineTypeAdapterGeneratorTest$TestClass;\n"
				+ "\n"
				+ "@FineMultiTarget\n"
				+ "public class GeneratedTypeAdapterTest {\n"
				+ "\n"
				+ "	@FineTarget(TestSuperClass.class)\n"
				+ "	public class TestSuperClassTypeAdapter extends FineTypeAdapter {\n"
				+ "	\n"
				...
				+ "	public class TestClassTypeAdapter extends FineTypeAdapter {\n"
				+ "	\n"
	...
	void testGenerateSingle() {
		...
		List<String> expected = new ArrayList<>(Arrays.asList(String.format("package typeadapter;\n"
				...
				+ "import com.minecrafttas.mctcommon.json.FineTypeAdapter;\n"
				+ "\n"
				+ "import mctcommon.json.FineTypeAdapterGeneratorTest$TestSubClass;\n"
				+ "\n"
